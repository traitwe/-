...
def main() -> None:
    q4_dir = ROOT / "outputs" / "question4_analysis"
    ...
    poi = pd.read_csv(ROOT / "data" / "clean" / "raw_cleaned" / "poi_qinhuangdao_purchased.csv", encoding="utf-8-sig")
    rules = {
    ...
    pd.DataFrame(rows).to_csv(ROOT / "outputs" / "question1_analysis" / "q1_poi_semantic_coverage.csv", index=False, encoding="utf-8-sig")
