...
\usepackage{amsmath,booktabs,graphicx,float,array}
...
\noindent\textbf{关键词：}旅游客流；尺度约束；日级预测；资源配置；情景优化
\end{abstract}
...
\section{问题一：多尺度客流时序构建}
\subsection{相对压力层与年度尺度层}
...
\section{问题三：停车、接驳与人员协同配置}
\subsection{需求换算与离散优化}
